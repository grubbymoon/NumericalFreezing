...
% Preprocessing -------------------------------
% reading the nodes
nodes      = dlmread('100_5nodes.txt');
% reading the element connectivity
elements   = dlmread('100_5elements.txt');
...
index2 = find(nodes(:,1) == 100); % get the index of nodes that the x value equals 100
